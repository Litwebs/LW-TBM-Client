  ...
  return (
    ...
    >
      ...
      <div className="ba-handle" style={{ left: `${pos}%` }} aria-hidden="true">
        ...
        <span className="ba-handle-knob ba-handle-pulse">
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 6l-6 6 6 6"/><path d="M15 6l6 6-6 6"/></svg>
        </span>
        <span className="ba-handle-line" />
      </div>
    </div>
