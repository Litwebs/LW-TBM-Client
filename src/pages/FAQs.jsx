...
export default function FAQs() {
  ...
  return (
    <div className="container">
      <Seo
        title="FAQs"
        description="Answers on installation, fire ratings, delivery, and returns for wall panels."
        path="/faqs"
      />
      <div className="page-header">
        <h1>FAQs</h1>
        <p>
          Whether you're planning a full renovation or a quick wall refresh, our FAQs cover
      ...
      <div className="container-narrow" style={{ paddingBottom: 80 }}>
        {filtered.length > 0 ? (
          ...
          <p className="muted center">No FAQs match your search.</p>
        )}
